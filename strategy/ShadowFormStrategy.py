...
class ShadowFormStrategy(CommonStrategy):
    ...
    def will_die_next_turn(self):
        ...
        if self.my_health <= self.oppo_total_attack + self.num_voidtouched_attendant_on_board * self.oppo_minion_num:
            return True
    ...
    def num_voidtouched_attendant_on_board(self):
        ...
        for minion in self.my_play_minions + self.oppo_play_minions:
    ...
    def num_minions_in_my_graveyard(self):
        count = 0
        for entity in self.my_graveyard_cards:
